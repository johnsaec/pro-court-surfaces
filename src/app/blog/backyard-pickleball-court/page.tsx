...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "How much does a backyard pickleball court cost?", acceptedAnswer: { "@type": "Answer", text: "A backyard pickleball court in Central Texas typically costs $15,000 to $40,000 total, including concrete slab ($8,000\u2013$20,000) and professional acrylic surfacing ($4,000\u2013$8,000). Costs vary based on site prep, drainage, and color options." } },
    ...
    { "@type": "Question", name: "What is the best surface for a backyard pickleball court?", acceptedAnswer: { "@type": "Answer", text: "Acrylic sport court surfaces (like ATS Acrytech) are the gold standard. They provide consistent ball bounce, good traction, and last 8\u201310 years in the Texas climate. Modular tiles are an alternative but offer inferior play quality." } },
    ...
    { "@type": "Question", name: "How long does it take to build a backyard pickleball court?", acceptedAnswer: { "@type": "Answer", text: "Total timeline is typically 6\u20138 weeks: 1\u20132 weeks for site prep and excavation, 1 week for concrete pour, 4 weeks for curing, then 3\u20135 days for surfacing and line striping." } },
...
const faqItems = [
  ...
  { question: "What is the best surface for a backyard pickleball court?", answer: "Acrylic sport court surfaces (like ATS Acrytech) are the gold standard for backyard pickleball courts. They provide consistent ball bounce, good traction, and last 8\u201310 years in the Texas climate. Modular snap-together tiles are an alternative but offer inferior play quality and less durability." },
  ...
  { question: "How long does it take to build a backyard pickleball court?", answer: "Total timeline is typically 6\u20138 weeks: 1\u20132 weeks for site prep and excavation, 1 week for the concrete pour, 4 weeks for curing, then 3\u20135 days for surfacing and line striping." },
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section id="cost">
          ...
          <CostTable title="Backyard Pickleball Court Costs (2026)" headers={["Item", "Cost Range"]} rows={[
            { label: "Site prep & grading", value: "$2,000 \u2013 $6,000" },
            { label: "Concrete slab (4\" min, 30'x60' to 34'x64')", value: "$8,000 \u2013 $20,000" },
            { label: "Acrylic surface system (ATS Acrytech)", value: "$4,000 \u2013 $8,000" },
          ...
          <div className="my-6 p-5 bg-brand-bg-alt border border-gray-200 rounded-xl">
            ...
            <div className="space-y-2 text-sm text-brand-text-muted">
              <p><strong className="text-brand-text">New build (from bare ground):</strong> $15,000 {"\u2013"} $40,000</p>
              <p><strong className="text-brand-text">Resurface existing slab:</strong> $4,000 {"\u2013"} $10,000</p>
              <p><strong className="text-brand-text">Convert tennis court to pickleball:</strong> $5,000 {"\u2013"} $15,000</p>
            </div>
          </div>
        ...
        <section id="surface">
          ...
          <p className="text-brand-text-muted leading-relaxed mb-6">There are three common options. We recommend acrylic for anyone who wants the real playing experience.</p>

          <div className="space-y-4 my-8">
            <div className="p-5 bg-white border border-gray-200 rounded-xl">
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-base font-semibold text-brand-text">Acrylic Sport Surface (Recommended)</h3>
                <span className="text-xs font-semibold text-brand-blue bg-brand-blue/10 px-2 py-0.5 rounded-full">Best</span>
              </div>
              <p className="text-sm text-brand-text-muted leading-relaxed">This is what we install {"\u2014"} the same <Link href="/blog/court-surface-types" className="text-brand-blue hover:underline">ATS Acrytech acrylic system</Link> used on commercial and tournament-level courts. Multi-coat application over concrete. Consistent ball bounce, excellent traction, custom colors, and 8{"\u2013"}10+ year lifespan in the Texas climate. This is the surface serious players want.</p>
            </div>
            <div className="p-5 bg-white border border-gray-200 rounded-xl">
        ...
        <section id="process">
          ...
          <p className="text-brand-text-muted leading-relaxed mb-6">The process takes about 6{"\u2013"}8 weeks from start to finish. Here is what each phase looks like.</p>
          ...
          <div className="space-y-6 my-8">
            {[
              ...
              { step: 2, title: "Site Prep & Excavation", description: "Clearing, grading, and compacting the subbase. If your lot has slope, this phase includes cut-and-fill work to create a level pad. Drainage is addressed here \u2014 proper slope away from the court and your home." },
              ...
              { step: 4, title: "Cure Time", description: "The concrete needs a full 28-day cure before surfacing can begin. This is non-negotiable \u2014 surfacing over uncured concrete causes adhesion failure and bubbling." },
